...
export const Products = [
    {
        ...
        fullData: `
            ...
            El Xiaomi Redmi Note 8 marca la octava generación de la serie Redmi Note, esta vez con una pantalla Full HD+ de 6.3 pulgadas y potenciado por un procesador Snapdragon 665 de ocho núcleos, el Redmi Note 8 cuenta con una cámara cuádruple en su posterior de 48 MP + 8 MP + 2 MP + 2 MP, y su cámara para selfies es de 13 megapixels. \n
            La principal queja en el Note 8 es la misma que en los teléfonos con una cámara trasera protuberante: al colocarlo sobre una superficie plana, el teléfono se va a columpiar.
        `,
        property: [
            "OS: Android 9.0 Pie",
            `Pantalla: 
            ...
            `Procesador: Snapdragon 665`,
            `Camara Frontal: 13 MP, vídeo 1080p@30`,
            `Bateria: 4.000 mAh 
            Carga rápida 18W`,
            `Dimensiones: 158,3 x 75,3 x 8,4 mm,
            Peso: 190 g`,
    ...
    },
    {
        ...
        property: [
            ...
            `Procesador: Snapdragon 665`,
            `Cámara: Cuádruple, 13MP+8MP +5MP+2MP`,
            `Batería: 5020 mAh 
            Carga rápida 18W`,
            `Peso: 198 g​`,
    ...
    },
    {
        ...
        property: [
            "OS: Android 10​ - MIUI 11",
            `Pantalla: 6,67 pulgadas 60 Hz IPS LCD
            Resolución: 2.400 x 1.080 px (20:9)
            Brillo de 450 nits`,
            ...
            `Bateria: 5.020 mAh
            Carga rápida 33W`,
            `Dimension: 165,75 x 76,68 x 8,8 mm
            Peso: 209 g`,
            `Cámara principal:
            Resolución: 64 MP
            Apertura: f/1.9`,
    ...
    },
    {
        ...
        fullData: `
            ...
            La nueva Mi Band 5 está pensada para que todos aquellos que aman el deporte puedan disfrutar a lo grande del mismo. Con la capacidad de recoger todos los datos que necesitas de tu práctica deportiva, también tiene la capacidad de poder mostrarte tu estado de salud: el estado de tu sueño y tu estado de salud, acompañados del control del ciclo menstrual.
        `,
        property: [
            "Pantalla a color de 1.1″",
            `11 modos deportivos`,
            `Te Permite conocer tu estado de salud:
            Vigila el sueño con detector de fase REM
            Control del ciclo menstrual y mucho más.`,
            `Idiomas:
            Admite inglés, español, ruso, holandés,
            italiano, francés, alemán, ucraniano,
            polaco, coreano, portugués, turco,
            japonés, árabe, checo, tailandés, chino,
            indonesio, griego, vietnamita y rumano.`,
            `Sensores:
            Sensor de aceleración de 3 ejes
            Giroscopio de 3 ejes
            Sensor de frecuencia cardiaca PPG`,
            `Conexión:
            Bluetooth 5.0 BLE
            OS: Android 5.0 o iOS 10.0
            APP Xiaomi Mi Fit (Android e iOS)`,
            `Batería: De polimero de iones de litio: 125 mAh
    ...
    },
    {
        ...
        fullData: `
            ...
            La batería de Xiaomi Mi Watch Lite es interminable para los estándares de los smartwatch. Nada de tener que cargarlo todos los días. Con un Mi Watch Lite puedes salir a hacer deporte y tendrá batería para muchos más días, incluso utilizando el GPS durante una actividad, como correr, andar en bici o hacer un paseo, este smartwatch logra alcanzar un máximo de 9 días de batería.
        `,
        property: [
            `Dimensiones: 4.1 x 3.5 x 1.1 cm
            Peso: 35 gramos`,
            `Pantalla: TFT/LCD 1.4 pulgadas
            320x320 píxeles`,
            `Bateria: 230 mAh - Duración de 9 días`,
